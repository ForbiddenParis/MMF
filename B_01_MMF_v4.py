...
the program will display the ticket sales information and white the data
to a text file.

It will also choose one lucky ticket holder who wins the
draw (their ticket will be free).
...
print(make_statement("Mini-Movie Fundraiser Program", "📽️"))
...
if tickets_sold == MAX_TICKETS:
    num_sold_string = make_statement(f"You have sold all the tickers "
